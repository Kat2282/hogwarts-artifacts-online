...
class ArtifactServiceTest {
    ...
    @Mock //telling mockito that we want to simulate, not call the real object
    ArtifactRepository artifactRepository;

    @Mock
    IdWorker idWorker;

    @InjectMocks //will inject a mock of the artifact repository object into an artifact service object
    ArtifactService artifactService;

    List<Artifact> artifacts;

    @BeforeEach //before each test method starts
    void setUp() {
    ...
    @AfterEach //after each test method finishes,
    void tearDown() {
    }

    @Test
    //a test method, when defined by @Test
    //here were testing the findById method
    void testFindByIdSuccess() {
        ...
        //setting wizard to own the artifact
        a.setOwner(w);

        given(artifactRepository.findById("1250808601744904192")).willReturn(Optional.of(a)); //defines the behavior of the mock object
            //when the findById gets called with this id, it will return a


        // When. Act on the target behavior (artifact service). When steps should cover the method to be tested.
    ...
    //Other test case: artifact can't be found with that id
    @Test
    void testFindByIdNotFound() {
        ...
        // Then
        assertThat(thrown)
                .isInstanceOf(ArtifactNotFoundException.class) //had to make the artifactnotfoundexception method
    ...
    void testUpdateSuccess() {
        ...
        assertThat(updatedArtifact.getDescription()).isEqualTo(update.getDescription());
            //guarantees they're only executed once
